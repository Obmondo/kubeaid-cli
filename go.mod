...
require (
	...
	sigs.k8s.io/cluster-api-provider-azure v1.22.4
...
replace (
	...
	// controller-runtime v0.23 (pulled by kubeone v1.13) needs the
	// k8s.io/* v0.34+ APIs, which the pins above hold at v0.33.
