...
require (
	...
	github.com/Azure/azure-workload-identity v1.6.1
	...
	github.com/syself/cluster-api-provider-hetzner v1.1.8
...
require (
	...
	github.com/koron-go/prefixw v1.0.2 // indirect
	...
	k8c.io/machine-controller v1.66.1 // indirect
	k8c.io/machine-controller/sdk v1.66.1 // indirect
...
replace (
	// argo-cd replaces its nested gitops-engine module with a local path,
	// which consumers can't resolve; point it at the v3.5.0 tag's commit.
	github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine v0.0.0-20260804074500-e95e1be88a2d

	// k3d (still on v5.9.0) can't handle the moby/moby type split in
	// docker/cli v29, which kubeone v1.13 pulls in.
	github.com/docker/cli => github.com/docker/cli v28.5.2+incompatible
)

tool github.com/Zxilly/go-size-analyzer/cmd/gsa
