...
const (
	...
	// netbird-keycloak Secret. Pre-generated by kubeaid-cli and
	// templated into a SealedSecret in kubeaid-config so the
	// netbird Helm chart can envFrom it. Same plaintext is
	// passed to ReconcileClient as netbird-backend's pre-set
	// secret — single git push, single sync.
	SecretNameNetBirdKeycloak = "netbird-keycloak"
	SecretKeyNetBirdClientID  = "OIDC_CLIENT_ID"
	SecretKeyNetBirdSecret    = "OIDC_CLIENT_SECRET"
