...
type (
	...
	FirewallConfig struct {
		...
		// AllowPublic lists extra public service ports beyond the chart default
		// (80/443/6443). This field is not currently rendered into the Cilium
		// CiliumClusterwideNetworkPolicy — publicPorts is fixed at [80, 443, 6443]
		// in the chart values overlay. To expose additional ports publicly, add them
		// directly to hostNetworkPolicy.publicPorts in the kubeaid-config values
		// overlay for the cilium chart.
